...
// phong
    ...
    private void initComponents() {
        ...
        jLabel2.setText("BÁO CÁO HOẠT ĐỘNG CỬA HÀNG TẠP HÓA");
        ...
        jLabel15.setText("III. Nhà cung cấp");

        jLabel16.setText("Tổng số nhà cung cấp:");
        ...
        jLabel19.setText("IV. Sản phẩm");

        jLabel20.setText("Tổng số Sản phẩm :");

        lbTongSoPhong.setText(". . . . . . . . ");

        jLabel21.setText("Sản phẩm đã bán :");
        ...
        jLabel23.setText("Sản phẩm tồn kho :");
        ...
        jLabel26.setText("Tổng tiền sản phẩm  :");
