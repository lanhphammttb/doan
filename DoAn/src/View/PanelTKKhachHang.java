...
public class PanelTKKhachHang extends javax.swing.JPanel {
...
//	String[][] QuocTich;
	...
	public void loaddataTable() {
		con.connect("QuanLySanPham", UserInfo.username, UserInfo.password);
		...
		colsName2.add("Địa chỉ ");
		colsName2.add("Số lượng");
		colsName3.add("Quốc tịch ");
		...
		String sql1 = "SELECT khachhang.GioiTinh, count(khachhang.GioiTinh)\n"
				+ "from khachhang\n"
				+ "group by khachhang.GioiTinh\n"
				+ ";";
		String sql2 = "SELECT khachhang.Diachi, count(khachhang.Diachi)\n"
				+ "from khachhang\n"
				+ "group by khachhang.Diachi\n"
				+ ";";
		String sql3 = "SELECT khachhang.Quoctich, count(khachhang.Quoctich)\n"
				+ "from khachhang\n"
				+ "group by khachhang.Quoctich\n"
				+ ";";
		...
		DiaChi = new String[vector2.size()][];
		for (int i = 0; i < vector2.size(); i++) {
			DiaChi[i] = vector2.get(i).split("\t");

		}
		vector3 = con.select2colLOI(sql3);
		QuocTich = new String[vector3.size()][];
		for (int i = 0; i < vector3.size(); i++) {
			QuocTich[i] = vector3.get(i).split("\t");
	...
	/**
	 * Creates new form PanelTKKhachHang
	 */
	public PanelTKKhachHang() {
		initComponents();
		loaddataTable();
		loaddataLabel();
	}
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Thống kê khách hàng theo giới tính");
        ...
        jLabel9.setText("Thống kê khách hàng theo địa chỉ :");
        ...
        jLabel13.setText("Thống kê khách hàng theo giới tính :");
        ...
        jLabel14.setText("Thống kê khách hàng theo quốc tịch :");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 536, Short.MAX_VALUE))
...
//			pr.printKhachHang(file.getPath(), s1, GioiTinh, DiaChi);
